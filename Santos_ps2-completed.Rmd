...
```{r}
d = read.spss("C:/Users/bsantos/Documents/Courses/PYSCH 251/problem_sets/data/Tamiretal2008ReplicationData.sav", to.data.frame=T)
```
...
```{r}
## your code here
range(d$Game1Angry1,na.rm=T) #suggests range of 1-7
...
performance_diff_summary_d = performance_diff_d %>%
  ...
  summarize(MeanImprovementScore = mean(PostMusic, na.rm=T)-mean(PreMusic, na.rm=T))
```
